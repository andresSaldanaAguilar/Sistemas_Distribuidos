...
public class Customers  implements java.io.Serializable {
    ...
    public String toString(){
        return this.customerId+";"+this.companyName+";"+this.contactName+";"+this.contactTitle+";"+this.address+";"+this.city+";"+this.region+";"+this.postalCode+";"+this.country+";"+this.phone+";"+this.fax+";";
    }
}
