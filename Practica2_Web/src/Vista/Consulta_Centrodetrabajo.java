 ...
 * @author sam-y
 */
public class Consulta_Centrodetrabajo extends javax.swing.JInternalFrame {

    String[][] datos;
    
    public Consulta_Centrodetrabajo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Centros de trabajo");
    ...
    void setVisible(Centrodetrabajo c) {
        setVisible(true);
        this.Tabla.setValueAt(c.getIdCentroDeTrabajo(), 0, 0);
        this.Tabla.setValueAt(c.getNombreCentroDeTrabajo(), 0, 1);
        String[][] datos2 = new String[2][2];
        datos2[0][0]="id";
        datos2[0][1]="nombre";
        datos2[1][0]=String.valueOf(c.getIdCentroDeTrabajo());
        datos2[1][1]=c.getNombreCentroDeTrabajo();
        datos=datos2;
    }
    ...
    void setVisible(boolean b, DefaultListModel dl) {
        ...
        Object[][] filas = new Object[dl.size()][2];
        String[][] datos2 = new String[dl.size()+1][2];
        datos2[0][0]="id";
        datos2[0][1]="nombre";
        for (int i = 0; i < dl.size(); i++) {
            Centrodetrabajo a = (Centrodetrabajo) dl.get(i); //ASI SE RECIBE UNA LISTA
            filas[i][0] = a.getIdCentroDeTrabajo();
            filas[i][1] = a.getNombreCentroDeTrabajo();
            
            datos2[i+1][0] = String.valueOf(a.getIdCentroDeTrabajo());
            datos2[i+1][1] = a.getNombreCentroDeTrabajo();
        }
        datos=datos2;
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
                filas,
