...
public class Centrodetrabajo  implements java.io.Serializable {
    ...
    public Centrodetrabajo(int idCentroDeTrabajo,String nombreCentroDeTrabajo) {
        this.idCentroDeTrabajo = idCentroDeTrabajo;
    ...
    public String toString() {
        return "Centrodetrabajo{" + "idCentroDeTrabajo=" + idCentroDeTrabajo + ", nombreCentroDeTrabajo=" + nombreCentroDeTrabajo + '}';
    }
